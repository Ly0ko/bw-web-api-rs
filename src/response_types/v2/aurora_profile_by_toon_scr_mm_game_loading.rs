...
#[serde(untagged)]
pub enum AuroraProfileByToonScrMmGameLoadingResponse {
    PlayerFound(AuroraProfileByToonScrMmGameLoadingResponsePlayerFound),
    PlayerNotFound(AuroraProfileByToonScrMmGameLoadingResponsePlayerNotFound),
}

#[derive(Serialize, Deserialize, Debug)]
pub struct AuroraProfileByToonScrMmGameLoadingResponsePlayerFound {
...
#[derive(Serialize, Deserialize, Debug)]
pub struct AuroraProfileByToonScrMmGameLoadingResponsePlayerNotFound {
    pub aurora_id: i32,
