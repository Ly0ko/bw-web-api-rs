...
#[serde(untagged)]
pub enum AuroraProfileByToonScrToonInfoResponse {
    PlayerFound(AuroraProfileByToonScrToonInfoResponsePlayerFound),
    PlayerNotFound(AuroraProfileByToonScrToonInfoResponsePlayerNotFound),
}

#[derive(Serialize, Deserialize, Debug)]
pub struct AuroraProfileByToonScrToonInfoResponsePlayerFound {
...
#[derive(Serialize, Deserialize, Debug)]
pub struct AuroraProfileByToonScrToonInfoResponsePlayerNotFound {
    pub aurora_id: i32,
    pub avatars: HashMap<String, String>,
    pub avatars_framed: HashMap<String, AvatarFramed>,
    pub avatars_unlocked: HashMap<String, AvatarUnlocked>,
