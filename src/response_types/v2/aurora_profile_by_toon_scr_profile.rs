...
#[serde(untagged)]
pub enum AuroraProfileByToonScrProfileResponse {
    PlayerFound(AuroraProfileByToonScrProfileResponsePlayerFound),
    PlayerNotFound(AuroraProfileByToonScrProfileResponsePlayerNotFound),
}

#[derive(Serialize, Deserialize, Debug)]
pub struct AuroraProfileByToonScrProfileResponsePlayerFound {
...
#[derive(Serialize, Deserialize, Debug)]
pub struct AuroraProfileByToonScrProfileResponsePlayerNotFound {
    pub aurora_id: i32,
    pub avatars: HashMap<String, String>,
    pub avatars_framed: HashMap<String, AvatarFramed>,
    pub avatars_unlocked: HashMap<String, AvatarUnlocked>,
